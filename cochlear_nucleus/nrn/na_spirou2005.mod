TITLE na_spirou2005.mod Sodium channel from Spirou et al. (2005)

COMMENT

This file implements the sodium channel from Spirou et al. (2005).  It
is based on the channel used in Rothman et al. (1993) that originated
in Frankenhaeuser and Huxley (1964).

Note that the original channels have m^2, while this one m^3.

ENDCOMMENT


NEURON {
    SUFFIX na_spirou2005
